...
bool isConstant(ExprRef e) { return e->kind() == Constant; }
...
void Expr::addConstraint(bool is_unsigned, Kind kind, llvm::APInt& rhs,
...
void Expr::addConstraint(RangeSet& range_set, Kind kind, llvm::APInt& rhs,
                         llvm::APInt& adjustment) {
    // C + A rel V
